...
public class ProfilePicActivity extends AppCompatActivity implements ProfilepicAdapter.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdUtils.showNativeAd(ProfilePicActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), findViewById(R.id.native_ads), false);
