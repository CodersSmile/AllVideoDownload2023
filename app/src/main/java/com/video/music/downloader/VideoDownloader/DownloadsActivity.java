...
//        setSupportActionBar(toolbar);
        AdUtils.showNativeAd(DownloadsActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), findViewById(R.id.native_ads), false);
...
//        }
    ...
    public void onBackPressed() {
        AdUtils.showInterstitialAd(DownloadsActivity.this, new AppInterfaces.InterStitialADInterface() {
            @Override
