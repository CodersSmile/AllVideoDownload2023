...
import com.video.music.downloader.Activity.PrivacyPolicy;
import com.video.music.downloader.Activity.SplashActivity;
...
public class VPNInitiator_Handler {
    ...
    Activity activity;
    AppInterfaces.VPNInterface vpnInterface;

    public VPNInitiator_Handler(Activity activity, AppInterfaces.VPNInterface vpnInterface) {
        ...
        mFirebaseRemoteConfig.fetchAndActivate().addOnCompleteListener(new OnCompleteListener<Boolean>() {
            ...
            public void onComplete(@NonNull Task<Boolean> task) {
                if (task.isSuccessful()) {
                    Constants.configData = Global.getConfigData(mFirebaseRemoteConfig.getString("vpn_config_red"));
                    Log.println(Log.ASSERT, TAG, new Gson().toJson(mFirebaseRemoteConfig.getString("vpn_config_red")));
