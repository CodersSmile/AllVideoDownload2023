...
//import com.video.music.downloader.MusicPlayer.Ringtone.adapter.RingtonesAdapter;
//import com.video.music.downloader.MusicPlayer.Ringtone.adapter.SongsAdapter;
//import com.video.music.downloader.MusicPlayer.Ringtone.model.Song;
//import com.video.music.downloader.MusicPlayer.Ringtone.viewmodel.SharedViewModel;
...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        if (isFragmentVisible) {
            super.onBackPressed();
            nav_host_fragment_container.setVisibility(View.GONE);
            fab.setVisibility(View.VISIBLE);
            isFragmentVisible = false;
        } else {

                AdUtils.showInterstitialAd(MusicPlayerActivity.this, new AppInterfaces.InterStitialADInterface() {
                    @Override
                    public void adLoadState(boolean isLoaded) {
                        startActivity(new Intent(getApplicationContext(), DashboardActivity.class));                        player.stop();
                    }
                });
...
//        AdUtils.showNativeAd(MusicPlayerActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), findViewById(R.id.native_ads), false);
...
//        playerControls();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                player.play();
                nav_host_fragment_container.setVisibility(View.VISIBLE);
...
//    }
    ...
    private void showSongs(List<Song> songs) {
        ...
        //adapter
        songsAdapter = new SongsAdapter(songs, player, controlsWrapper, fab);
