...
import com.video.music.downloader.Activity.DetailsDialog;
...
//    AppUpdateManager mAppUpdateManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdUtils.showNativeAd(MainActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), findViewById(R.id.native_ads), false);
